...
void display_text()
{
	...
	{
		bitmap_output(10, 575, "MENU: ",GLUT_BITMAP_HELVETICA_12);
...
void front()
{
	...
	glBegin(GL_QUADS);
		glVertex2f(256,120.0);
		glVertex2f(256,170);
		glVertex2f(532,170);
		glVertex2f(532,120.0);
	glEnd();
	glColor3f(0.0,1.0,1.0);
	bitmap_output(256, 125, "Press Enter to continue.......",GLUT_BITMAP_HELVETICA_18);
}
